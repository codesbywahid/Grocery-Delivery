...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-secter">
        ...
        <div className="relative max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
